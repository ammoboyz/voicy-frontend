    ...
    const viewsHtml = showViews
      ? `
        <div class="info-element info-element--views">
          <span class="info-element__value">
            ${formatViews(sound.views_count ?? 0)}
          </span>
        </div>
      `
      : '';
    ...
    const footRightHtml = (context === 'uploads')
      ...
      : `
        <button class="like-button ${sound.liked ? 'is-active' : ''}" type="button" data-id="${sound.id}">
          ...
          >
            <path
              d="M9 15s-6.5-4.1-8.2-7.7C-0.7 3.8 1.6 0.9 4.7 1
                c1.6 0 3 0.9 4.3 2.4C10.3 1.9 11.7 1 13.3 1
                c3.1-0.1 5.4 2.8 3.9 6.3C15.5 10.9 9 15 9 15z"
              fill="none"
              stroke="currentColor"
              stroke-width="1.5"
            />
      ...
      <div class="sound-card" data-sound-id="${sound.id}">
        <div class="sound-card__top">
          <button class="sound-card__play-button play-button" type="button" data-url="${sound.url}">
            <!-- PLAY -->
            <svg class="play-button__icon-play" width="20" height="24" viewBox="0 0 20 24" fill="none"
              xmlns="http://www.w3.org/2000/svg">
              <path
                d="M17.492 7.95991L7.95401 0.965913C7.20903 0.420398 6.32755 0.0918256 5.40727 0.0166162C4.48699 -0.0585933 3.56385 0.122498 2.74019 0.539817C1.91653 0.957137 1.22451 1.59438 0.740848 2.38092C0.257183 3.16746 0.00076115 4.07256 6.03388e-06 4.99591V18.9909C-0.00143046 19.9152 0.253651 20.8217 0.736856 21.6096C1.22006 22.3975 1.91243 23.0358 2.7369 23.4535C3.56137 23.8712 4.48559 24.052 5.40668 23.9756C6.32777 23.8992 7.2096 23.5687 7.95401 23.0209L17.492 16.0269C18.1249 15.5625 18.6395 14.9555 18.9942 14.2552C19.349 13.5549 19.5338 12.7809 19.5338 11.9959C19.5338 11.2109 19.349 10.4369 18.9942 9.73661C18.6395 9.03631 18.1249 8.42936 17.492 7.96491V7.95991Z"
                fill="white"
              />
            </svg>

            <!-- STOP -->
            <svg class="play-button__icon-stop" width="24" height="24" viewBox="0 0 24 24" fill="none"
              xmlns="http://www.w3.org/2000/svg">
              <path
                d="M6.49999 0C5.57173 0 4.6815 0.368749 4.02512 1.02513C3.36874 1.6815 2.99999 2.57174 2.99999 3.5V20.5C2.99999 21.4283 3.36874 22.3185 4.02512 22.9749C4.6815 23.6313 5.57173 24 6.49999 24C7.42825 24 8.31849 23.6313 8.97487 22.9749C9.63124 22.3185 9.99999 21.4283 9.99999 20.5V3.5C9.99999 2.57174 9.63124 1.6815 8.97487 1.02513C8.31849 0.368749 7.42825 0 6.49999 0Z"
                fill="white"
              />
              <path
